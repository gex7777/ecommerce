...
const Tos = () => {
  return (
    <div className="container mx-auto">
      ...
      <p>
        This website is operated by Jancy Teachers Food Products. Throughout the
        site, the terms &ldquo;we&rdquo;, &ldquo;us&rdquo; and &ldquo;our&rdquo;
        refer to Jancy Teachers Food Products. Jancy Teachers Food Products
      ...
      <p className="font-bold text-xs">SECTION 1 - ONLINE STORE TERMS</p>
      ...
      <p className="font-bold text-xs">SECTION 2 - GENERAL CONDITIONS</p>
      ...
      <p className="font-bold text-xs">SECTION 6 - THIRD-PARTY LINKS</p>
      ...
      <p>
        ...
        any party&rsquo;s intellectual property or these Terms of Service. You
      ...
      <p className="font-bold text-xs">SECTION 8 - PERSONAL INFORMATION</p>
      ...
      <p className="font-bold text-xs">SECTION 10 - PROHIBITED USES</p>
      ...
      <p>
        ...
        durability, title, and non-infringement. In no case shall Jancy Teachers
        Food Products, our directors, officers, employees, affiliates, agents,
      ...
      <p className="font-bold text-xs">SECTION 12 - INDEMNIFICATION</p>

      <p>
        You agree to indemnify, defend and hold harmless Jancy Teachers Food
        Products and our parent, subsidiaries, affiliates, partners, officers,
      ...
      <p className="font-bold text-xs">SECTION 13 - SEVERABILITY</p>
      ...
      <p className="font-bold text-xs">SECTION 14 - TERMINATION</p>
      ...
      <p className="font-bold text-xs">SECTION 15 - ENTIRE AGREEMENT</p>
      ...
      <p className="font-bold text-xs">SECTION 16 - GOVERNING LAW</p>
      ...
      <p className="font-bold text-xs">SECTION 18 - CONTACT INFORMATION</p>
